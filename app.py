...
class Catalogo:
    ...
    #----------------------------------------------------------------
    def agregar_producto(self, descripcion, Color, precio, imagen, proveedor):
               
        sql = "INSERT INTO productos (descripcion, Color, precio, imagen_url, proveedor) VALUES (%s, %s, %s, %s, %s)"
        valores = (descripcion, Color, precio, imagen, proveedor)
    ...
    #----------------------------------------------------------------
    def modificar_producto(self, codigo, nueva_descripcion, nueva_Color, nuevo_precio, nueva_imagen, nuevo_proveedor):
        sql = "UPDATE productos SET descripcion = %s, Color = %s, precio = %s, imagen_url = %s, proveedor = %s WHERE codigo = %s"
        valores = (nueva_descripcion, nueva_Color, nuevo_precio, nueva_imagen, nuevo_proveedor, codigo)
        self.cursor.execute(sql, valores)
        self.conn.commit()
...
""" catalogo = Catalogo(host='localhost', user='root', password='gonzasana1', database='miapp') """
catalogo = Catalogo(host='gonzasana.mysql.pythonanywhere-services.com', user='gonzasana', password='uHrDCGg85@Yq886', database='gonzasana$miapp')
...
RUTA_DESTINO = '/home/gonzasana/mysite/static/imagenes'
...
def agregar_producto():
    ...
    nuevo_codigo = catalogo.agregar_producto(descripcion, Color, precio, nombre_imagen, proveedor)
    if nuevo_codigo:    
...
def modificar_producto(codigo):
    ...
    nueva_Color = request.form.get("Color")
    ...
    if catalogo.modificar_producto(codigo, nueva_descripcion, nueva_Color, nuevo_precio, nombre_imagen, nuevo_proveedor):
